                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="img/s_whitelogo.png" alt="">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="slider_text text-center justify-content-center">
                         <div class="jumbotron">
                                                <ul class="nav justify-content-center">
                                                  <li class="nav-item">
                                                    <a class="nav-link active btn2" href="centerposition.mc"> 중간 지점으로 찾기</a>
                                                          </li>
                                                ...
                                                -->
                                                          <li class="nav-item">
                                                            <a class="nav-link btn2" href="areaposition.mc">지역으로 검색하기</a>
                                                          </li>
                                                        </ul>
                                                        <hr style="border: dashed 2px #1c3349;">
                                                 <c:choose>
