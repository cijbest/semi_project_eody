...
public class SearcherController {
	...
	public ModelAndView useraddimpl(ModelAndView mv, SearcherVO searcher, String user_birth_year,
...
//		public ModelAndView listing(ModelAndView mv) {
//			mv.setViewName("searcher/listing");
//			ArrayList<HotPlaceVO> list1 = null;
//			ArrayList<ShopVO> list2 = null;
//			try {
//				list1 = hbiz.get();
//			} catch (Exception e) {			
//				e.printStackTrace();
//			}	
//			mv.addObject("hlist", list1);	
//			
//			try {
//				list2 = shbiz.get();
//			} catch (Exception e) {			
//				e.printStackTrace();
//			}	
//			mv.addObject("shoplist", list2);	
//			return mv;
//		}
		
//		@RequestMapping("/shoplist.mc")
//		public ModelAndView shoplisting(ModelAndView mv, String h_name) {
//			ArrayList<HotPlaceVO> list1 = null; //핫플레이스 리스트
//			try {
//				list1 = hbiz.get();
//			} catch (Exception e) {			
//				e.printStackTrace();
...
//			
//			ArrayList<ShopVO> list2 = null;  //핫플레이스의 shop list
//			try {
//				list2 = shbiz.shop_hotplace_get(h_name);
//			} catch (Exception e) {			
//				e.printStackTrace();
//			}	
//			mv.addObject("shoplist", list2);
